...
TestData testData = findTestData("Data Files/Excel Data")
...
for(int row=1; row<=57; row++) {
	employees.add(new Employee(testData.getValue(1, row),
												 ...
												 testData.getValue(5, row), 
												 testData.getValue(6, row)));
}
// q1: salary of Bradley
Employee employee1 = employees.find { it.name.contains('Bradley') };
println "Bradley salary is: ${employee1.salary}";
